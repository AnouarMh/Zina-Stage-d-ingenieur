     ...
     <div class="search-result" >
          ...
          <div class="card-body pt-15">
            ...
            <div class="d-flex flex-center flex-column mb-5"    v-if="fournisseur" >
              ...
              <a
                class="fs-3 text-gray-800 text-hover-primary fw-bold mb-1"
              >
              Tarif :{{ fournisseur.tarif}} DT
  
              </a>
              <a
                class="fs-3 text-gray-800 text-hover-primary fw-bold mb-1"
              >
              Durée :{{ fournisseur.duree}} H
      ...
      <div class="flex-lg-row-fluid ms-lg-20">
        ...
        <div class="fv-row mb-10">
         ...
         <button class="btn btn-succes" @click="saveChanges">Resérver {{ fournisseur.nom }} </button>
        ...
        <div class="card-body pt-15">
            <!--begin::Summary-->
            <div class="d-flex flex-center flex-column mb-5"    v-if="mydata" >
              ...
              <a
                class="fs-3 text-gray-800 text-hover-primary fw-bold mb-1"
              >
              Nom de Centre : {{ mydata.nom }}
              </a>
              <div class="badge badge-light-info d-inline">{{ mydata.country }}</div>

              <a
                class="fs-3 text-gray-800 text-hover-primary fw-bold mb-1"
              >
                Numero Telephone : {{ mydata.numerotel }}
              </a>
              <a
                class="fs-3 text-gray-800 text-hover-primary fw-bold mb-1"
              >
              Horraire : {{ mydata.horaire }}
              </a>
              <a
                class="fs-3 text-gray-800 text-hover-primary fw-bold mb-1"
              >
              Localisation : {{ mydata.localisation }}
              </a>
              <a
                class="fs-3 text-gray-800 text-hover-primary fw-bold mb-1"
              >
...
import {deleteClient,approuverClient,getServicesClient ,type Service } from "@/core/data/customers";
import {addreservation,getClientsByAdmin }from "@/core/data/customers";
...
console.log(formattedDate);
  ...
  const response =await getServicesClient(adminId);
  fournisseur.value = response;

  const adminResponse = await getServicesClient(adminId);
