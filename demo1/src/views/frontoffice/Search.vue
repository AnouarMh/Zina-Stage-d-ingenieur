  ...
  >
    ...
    <div class="searchby etab" v-for="result in searchResults" :key="result.id">
      ...
      <div class="card-content">
        ...
        <p class="card-price">{{ result.country }}</p>
    ...
    <div class="searchbyheader" v-for="centre in Centrescat" :key="centre.id">
      ...
      <div class="card-content">
        ...
        <p class="card-price">{{ centre.country }}</p>
        <p class="card-status open">Open</p>
    ...
    <transition name="fade">
      <div v-if="service.showDetails" class="service-details">
        ...
        <div class="service-buttons">
          <button @click="reserveService(service.id)">Réserver</button>
        </div>
      </div>
    </transition>
  </li>
...
export default { 
  ...
  setup() {
    ...
    const reserveService = (id) => {
      console.log('Réserver le service avec l\'id:', id);
...
computed: {
  ...
  try {
    const response = await axios.get('/clients/searchbyetab', {
      params: dataform
    });
