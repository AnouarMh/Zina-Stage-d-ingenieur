            ...
            <div class="d-flex flex-column">
              ...
              <div class="d-flex align-items-center mb-2">
                <a
                  ...
                  > {{admin.nom}} {{ admin.prenom }}</a
                >
                <a href="#">
                  <span class="svg-icon svg-icon-1 svg-icon-primary">
                    <inline-svg
                      :src="
                        getAssetPath('media/icons/duotune/general/gen026.svg')
                      "
                    />
                  </span>
                </a>
              ...
              <div class="d-flex flex-wrap fw-semobold fs-6 mb-4 pe-2">
                ...
                >
                  <span class="svg-icon svg-icon-4 me-1">
                    <inline-svg
                      :src="
                        getAssetPath('media/icons/duotune/general/gen018.svg')
                      "
                    />
                  </span>
                  {{ admin.country }}
                ...
                >
                  <span class="svg-icon svg-icon-4 me-1">
                    <inline-svg
                      :src="
                        getAssetPath(
                          '/media/icons/duotune/communication/com011.svg'
                        )
                      "
                    />
                  </span>
            ...
            <div class="d-flex my-4">
              ...
              >
                <span class="svg-icon svg-icon-3 d-none">
                  <inline-svg
                    :src="
                      getAssetPath('media/icons/duotune/arrows/arr012.svg')
                    "
                  />
                </span>
                Follow
