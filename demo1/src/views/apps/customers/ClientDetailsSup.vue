<template>
          ...
          <div class="card-body pt-15">
            ...
            <div id="kt_customer_view_details" class="collapse show"     v-if="fournisseur">
              <div class="py-5 fs-6">
                ...
                <!--begin::Details item-->
                <!--begin::Details item-->
                <div class="fw-bold mt-5">Approuver</div>
                <div class="text-gray-600">{{ fournisseur.approuver }}</div>
                <!--begin::Details item-->
                <!--begin::Details item-->
  ...
  import {updateClient,getClientsByAdmin }from "@/core/data/customers";
  ...
  const fournisseur = ref<Client>({} as Client);
   ...
   //get admin by id with axios
      ...
      onMounted(async () => {
          ...
          const response =await getClientById(adminId);
    ...
    window.location.href = '#/home/client';
      ...
      const AprvFrnsr = () => { 
        ...
        approuverClient(adminIdToDelete)
        .then((response) => {
          Swal.fire({
        text: "Le profil de '" + fournisseur.value?.nom + "' a été approuver avec succès.",
            icon: "success",
            confirmButtonText: "Ok",
            buttonsStyling: false,
            heightAuto: false,
