...
import AddCustomerModal from "@/components/modals/forms/AddCenter.vue";
import { getCustomers, type ICustomer } from "@/core/data/customers";
...
export default defineComponent({
  ...
  setup() {
    ...
    const navigateToAdminDetails = (customerId: number) => {
      router.push({ name: "admin-details", params: { id: customerId } });
    };
