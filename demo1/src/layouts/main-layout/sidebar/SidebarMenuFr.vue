<template>
          ...
          <div class="menu-item">
            ...
            >
              <span class="menu-icon">
                ...
                >
                  <inline-svg
                    :src="getAssetPath('media/icons/duotune/general/gen002.svg')"
                  />
                </span>
              </span>
          ...
          <div class="menu-item">
            ...
            >
              <span class="menu-icon">
                ...
                >
                  <inline-svg
                    :src="getAssetPath('media/icons/duotune/coding/cod003.svg')"
                  />
                </span>
              </span>
  ...
  import MainMenuConfig from "@/core/config/MainMenuConfigFr";
